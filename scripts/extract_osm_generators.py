...
Results (North America, July 2026 filtered PBF):
  Node generators (ogr2ogr):         155,530
  Non-solar polygon generators:        2,822  (3,057 found, 235 dropped as
                                               duplicates within 200 m of a node)
  Combined after deduplication:      158,352
...
def main():
    ...
    if args.input:
        ...
        pbf = find_pbf(args.input_dir, need_tags=["power=generator"])
        if not pbf:
