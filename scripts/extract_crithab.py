...
Why local pmtiles, not the live ArcGIS tile service: the FWS ArcGIS service is
unreliable and has no CORS guarantee (see docs/layers/crithab.md history).
We pre-bake a PMTiles file hosted alongside the map. No download pack is offered
