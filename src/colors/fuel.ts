...
export const VOLTAGE_LEGEND = [
  { id: "550+",    urlCode: "H", label: "≥ 550 kV",   color: "#f97316" },
  { id: "500-549", urlCode: "F", label: "500–549 kV", color: "#ef4444" },
  { id: "300-499", urlCode: "G", label: "300–499 kV", color: "#22c55e" },
  { id: "200-299", urlCode: "T", label: "200–299 kV", color: "#3b82f6" },
  { id: "100-199", urlCode: "P", label: "100–199 kV", color: "#ec4899" },
  { id: "<100",    urlCode: "L", label: "< 100 kV",  color: "#eab308" },
