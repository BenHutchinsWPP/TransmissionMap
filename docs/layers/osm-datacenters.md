...
| `im3_sqft` | 77% | `105786`, `158463` — joined at build time from IM3 Atlas; filled where a building/campus footprint matched (high overlap: IM3 is itself OSM-derived; unmatched rows are mostly Canada/Mexico, outside IM3's US coverage). Circle size on the map scales with this value |
