...
**[WestTEC 10 Yr](westtec-10yr.md)** overlays the transmission portfolio from the WestTEC West-Wide Transmission Study, 10-Year Horizon Report (Western Transmission Expansion Coalition, a Western Power Pool initiative) — planned projects plus the upgrades WestTEC identified to serve the Western Interconnection through 2035. Colorable by scenario (Base Case, SRA, IDA, Congestion) or by project type (planned vs. identified).
