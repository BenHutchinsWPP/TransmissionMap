...
| **[Census Cartographic Boundary Files](https://www.census.gov/geographies/mapping-files/time-series/geo/carto-boundary-file.html)** | [Tribal lands](layers/tribal-lands.md) · [County boundaries](layers/boundaries.md) · [Census States](layers/us-states.md) · [Census ZIP Codes (ZCTA)](layers/us-zcta.md) | Public domain — US federal work, 17 U.S.C. § 105 | "U.S. Census Bureau, TIGER/Line" |
| **[geoBoundaries](https://www.geoboundaries.org/)** (William & Mary geoLab) | [Countries](layers/countries.md) · [States / Provinces (Admin-1)](layers/admin1.md) | **[CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)** — attribution **required** | "geoBoundaries — William & Mary geoLab" |
...
| **EIA** | [Generators (Form 860)](layers/eia-generators.md) · [Balancing Authorities](layers/eia-ba.md) | Public domain — US federal work, 17 U.S.C. § 105 | "Source: U.S. EIA, Form EIA-860" / "U.S. Energy Information Administration" |
