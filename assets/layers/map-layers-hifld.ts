...
export function addHifldNatgasLines() {
  ...
  state.map.addLayer({
    id: "hifld-natgas-interstate",
    type: "line", source: "hifld-natgas-lines",
    "source-layer": "hifld_natgas_lines", minzoom: 0,
    filter: ["==", ["get", "pipe_type"], "Interstate"],
    layout: { visibility: visI, "line-cap": "butt", "line-join": "round" },
    paint: { "line-color": NATGAS_LINE_COLOR, "line-width": lineWidth,
             "line-dasharray": dashArray, "line-opacity": 0.85 },
  } as unknown as LayerSpecification);
  registerBaseFilter("hifld-natgas-interstate", ["==", ["get", "pipe_type"], "Interstate"]);

  state.map.addLayer({
    id: "hifld-natgas-intrastate",
    type: "line", source: "hifld-natgas-lines",
    "source-layer": "hifld_natgas_lines", minzoom: 5,
    filter: ["==", ["get", "pipe_type"], "Intrastate"],
    layout: { visibility: visI, "line-cap": "butt", "line-join": "round" },
    paint: { "line-color": NATGAS_LINE_COLOR, "line-width": lineWidth,
             "line-dasharray": dashArray, "line-opacity": 0.80 },
  } as unknown as LayerSpecification);
  registerBaseFilter("hifld-natgas-intrastate", ["==", ["get", "pipe_type"], "Intrastate"]);

  state.map.addLayer({
    id: "hifld-natgas-hgl",
    type: "line", source: "hifld-natgas-lines",
    "source-layer": "hifld_natgas_lines", minzoom: 5,
    filter: ["==", ["get", "pipe_type"], "HGL"],
    layout: { visibility: visI, "line-cap": "butt", "line-join": "round" },
    paint: { "line-color": NATGAS_LINE_COLOR, "line-width": lineWidth,
             "line-dasharray": dashArray, "line-opacity": 0.80 },
  } as unknown as LayerSpecification);
  registerBaseFilter("hifld-natgas-hgl", ["==", ["get", "pipe_type"], "HGL"]);

  state.map.addLayer({
    id: "hifld-natgas-gathering",
    type: "line", source: "hifld-natgas-lines",
    "source-layer": "hifld_natgas_lines", minzoom: 7,
    filter: ["==", ["get", "pipe_type"], "Gathering"],
    layout: { visibility: visI, "line-cap": "butt", "line-join": "round" },
    paint: { "line-color": NATGAS_LINE_COLOR, "line-width": lineWidth,
             "line-dasharray": dashArray, "line-opacity": 0.75 },
  } as unknown as LayerSpecification);
  registerBaseFilter("hifld-natgas-gathering", ["==", ["get", "pipe_type"], "Gathering"]);
}
