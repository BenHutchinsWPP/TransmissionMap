...
import { addWildfireHazard, addWildfireLive, addSeismicHazard, addOdinOutages, addNwsAlerts, addNexradRadar } from './map-layers-hazards.js';
...
export function addAllLayers() {
  ...
  addNexradRadar();     // live raster — external IEM tiles; sits low so vector infra draws on top
